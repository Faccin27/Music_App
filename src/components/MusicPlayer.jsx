...
const songs = [
  ...
  {
    id: 10,
    name: 'Te Pego de Jeito',
    artist: 'Sorriso Maroto',
    album: 'Sorriso 20 Anos',
    duration: '3:50',
    image: wiu,
  },
  {
  ...
  {
    id: 13,
    name: 'Apenas Mais Uma de Amor',
    artist: 'Luan Santana',
    album: 'Luan Santana – Ao Vivo',
    duration: '3:34',
    image: wiu,
  },
  {
    id: 14,
    name: 'Não Perco Meu Tempo',
    artist: 'Giulia Be',
    album: 'Ai, Ai, Ai',
    duration: '3:09',
    image: wiu,
  ...
  },
  {
    id: 16,
    name: 'Medo Bobo',
    artist: 'Maiara & Maraísa',
    album: 'Maiara & Maraísa',
    duration: '3:18',
    image: wiu,
  },
]
...
const artists = [
  ...new Set(songs.flatMap((song) => song.artist.split(', '))),
].map((artist) => ({
  name: artist,
  image: wiu,
}))
